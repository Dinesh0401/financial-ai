          ...
          <Card data-animate="hero" className="grid-stripes border-border/60 bg-card/70 backdrop-blur-xl">
            <CardContent className="grid gap-8 p-6 lg:grid-cols-[1fr_0.9fr]">
              <div>
                ...
                <h2 data-animate="hero-heading" className="mt-4 text-4xl font-semibold tracking-tight text-foreground">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {dashboard.quick_insights.length > 0 ? (
                    dashboard.quick_insights.map((insight) => (
                      <Badge key={insight} data-animate="badge" variant="outline" className="rounded-full border-primary/30 bg-primary/10 px-3 py-1.5 text-xs text-primary">
                        {insight}
                      </Badge>
                    ))
                  ) : (
                    <Badge data-animate="badge" variant="outline" className="rounded-full border-border/60 bg-background/30 px-3 py-1.5 text-xs text-muted-foreground">
                      Add transactions to unlock live insights.
                    </Badge>
                  )}
                </div>
              </div>
              <div data-animate="gauge" className="flex items-center justify-center">
                <HealthGauge score={health.score} />
              </div>
            </CardContent>
          </Card>

          <Card data-animate="profile" className="border-border/60 bg-card/80 backdrop-blur-xl">
            <CardHeader>
